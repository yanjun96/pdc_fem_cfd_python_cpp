...
%plot(t(1,1:N(1))',f_ex(1,1:N(1))',  t(1,1:N(1))',f_im(1,1:N(1))',  t(1,1:N(1))',f_cn(1,1:N(1))', linewidth=1);
%hold on
...
plot(t(2,1:N(2))',f_ex(2,1:N(2))',  t(2,1:N(2))',f_im(2,1:N(2))',  t(2,1:N(2))',f_cn(2,1:N(2))', linewidth=1);
hold on
